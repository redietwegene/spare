             ...
             <div>
                   ...
                   <img className='w-full' src={img26} alt="" />
                    ...
                    <div className='absolute top-50 left-80 space-y-3 flex flex-col items-center text-white '>
                        ...
                        <p className='text-6xl'>Business</p>
                        <p className='font-extralight '>Need an extra hand? Our helper services connect you with skilled
                            professionals for tasks like moving, organizing, and more.</p>
      ...
      <div className='bg-cont p-6  overflow-hidden mb-19'>
          <div className=' flex justify-around m-32 relative'>
              <div className=''>
                  ...
                  <img  src={img24}  className='absolute bottom-50 left-30 '/>
