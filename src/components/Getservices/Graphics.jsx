...
import img29 from '../../assets/image 28.png'
import img30 from '../../assets/image29.png'
    ...
    return (
        <>
             <div>
                   ...
                   <img className='w-full' src={img29} alt="" />
                    ...
                    <div className='absolute top-50 left-80 space-y-3 flex flex-col items-center text-white '>
                        <p className='font-extralight text-2xl '>Reliable and Stable Crews</p>
                        <p className='text-6xl'>Graphics & Design</p>
                        <p className='font-extralight '>Get from point A to B with ease. Our rider services offer reliable transportation solutions tailored to your needs.
</p>
      ...
      <div className='bg-cont p-6  overflow-hidden mb-19'>
          <div className=' flex justify-around m-32 relative'>
              <div className=''>
                  ...
                  <img  src={img30}  className='absolute bottom-50 left-30 '/>
