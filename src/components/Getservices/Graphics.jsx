            ...
            <div>
                <div className='relative w-full'>
                    ...
                    <div className='absolute top-1/3 left-1/2 transform -translate-x-1/2 space-y-3 flex flex-col items-center text-white'>
                        ...
                        <p className='text-4xl md:text-6xl'>Graphics & Design</p>
                        <p className='font-extralight text-sm md:text-base text-center'>Get from point A to B with ease. Our rider services offer reliable transportation solutions tailored to your needs.</p>
                    </div>
                </div>
            </div>
