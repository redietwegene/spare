...
import img23 from '../../assets/image.png'
        ...
        <>
             <div>
                   ...
                   <img className='w-full' src={img25} alt="" />
                    ...
                    <div className='absolute top-50 left-70 space-y-3 flex flex-col items-center text-white '>
                        <p className='font-extralight text-2xl '>Reliable and Stable Crews</p>
                        <p className='text-6xl'>Helper</p>
                        <p className='font-extralight '>Need an extra hand? Our helper services
                            connect you with skilled professionals for tasks like moving, organizing, and more..</p>
      ...
      <div className='bg-cont p-6  overflow-hidden mb-19'>
          <div className=' flex justify-around m-32 relative'>
              <div className=''>
                  ...
                  <img  src={img23}  className='absolute bottom-50 left-35 '/>
