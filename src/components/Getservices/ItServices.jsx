            ...
            <div>
                <div className='relative w-full'>
                    ...
                    <div className='absolute top-1/3 left-1/2 transform -translate-x-1/2 space-y-3 flex flex-col items-center text-white'>
                        ...
                        <p className='text-4xl md:text-6xl'>IT Services</p>
                        <p className='font-extralight text-sm md:text-base text-center'>Explore our wide range of IT services, including programming, graphic design, digital marketing, and more. Designed to meet your professional needs.</p>
                    </div>
                </div>
            </div>
