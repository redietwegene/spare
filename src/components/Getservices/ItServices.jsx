             ...
             <div>
                   ...
                   <img className='w-full' src={img10} alt="" />
                    ...
                    <div className='absolute top-50 left-50 space-y-3 flex flex-col items-center text-white '>
                        ...
                        <p className='text-6xl'>IT Services</p>
                        <p className='font-extralight '>Explore our wide range of IT services, including programming, graphic design, digital marketing,
                            and more. Designed to meet your professional needs.</p>
      ...
      <div className='bg-cont p-6  overflow-hidden mb-19'>
          <div className=' flex justify-around m-32 relative'>
              <div className=''>
                  ...
                  <img  src={img9}  className='absolute bottom-50 left-30 '/>
